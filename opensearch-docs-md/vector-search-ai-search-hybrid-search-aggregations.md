...
source_url: https://docs.opensearch.org/latest/vector-search/ai-search/hybrid-search/aggregations/
---

# Combining hybrid search and aggregations

Source: https://docs.opensearch.org/latest/vector-search/ai-search/hybrid-search/aggregations/
...
You can enhance search results by combining a hybrid query clause with any aggregation that OpenSearch supports. Aggregations allow you to use OpenSearch as an analytics engine. For more information about aggregations, see [Aggregations](https://docs.opensearch.org/latest/aggregations/).

Most aggregations are performed on the subset of documents that is returned by a hybrid query. The only aggregation that operates on all documents is the [`global`](https://docs.opensearch.org/latest/aggregations/bucket/global/) aggregation.
...
Want to contribute? [Edit this page](https://github.com/opensearch-project/documentation-website/edit/main/_vector-search/ai-search/hybrid-search/aggregations.md) or [create an issue](https://github.com/opensearch-project/documentation-website/issues/new?assignees=&labels=untriaged&template=issue_template.md&title=%5BDOC%5D).
